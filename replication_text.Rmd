...
```
<img src="replication_venn.tiff".png" width="500px"/>
...
pie <- bp + coord_polar("y", start=45) + blank_theme + theme(axis.text.x=element_blank()) + geom_text(aes(x = 1.6, label = c("q 380", "fer 31", "for 16", "inf 23")), size=3, position = position_stack(vjust = 0.5))
pie
